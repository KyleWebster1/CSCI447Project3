...
class FeedForwardNeuralNetwork:
    ...
    def change_weights(self, layer, delta, weights, momentum):
        return layer.delta * weights.T * momentum

    def backprop(self, data, correct_answer, momentum, output):
        for i in reversed(range(len(self.total_layers)-1)):
            ...
            layer.weights += change_weights(layer, layer.delta, layer.weights, momentum)
            print(layer.delta)
        #TODO 
